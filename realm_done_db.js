...
var DoneRealm = require('realm');
var util = require('util')
var fs = require('fs');
var os = require('os');

DoneRealm.defaultPath = __dirname + "/realm_done/done.realm"
...
var done = new DoneRealm({schema: [Track]});

function DoneRealmDB() {
}

DoneRealmDB.prototype.getDB = function() {
    return done;
}


module.exports = DoneRealmDB;
